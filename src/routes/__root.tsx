...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Tailwind 实战学习 v3 · 系统路径",
      },
      {
        name: "description",
        content:
          "Tailwind CSS 中文交互教程：对齐 tailwindcss.com 官方文档：路径、文档地图、Live Demo、参考目录与工坊。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('tw-learn-ctp-flavor');var a=localStorage.getItem('tw-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['green','mauve','blue','lavender','sapphire','teal','peach','pink'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='teal';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','teal');}})();";
